/*
    ...
    make in order to sink the ball in the hole to complete the play. Depending on how far above or below par 
    ...
    par + 2	"Double Bogey"
    >= par + 3	"Go Home!"
    par and strokes will always be numeric and positive. We have added an array of all the names for your 
    convenience.
*/
